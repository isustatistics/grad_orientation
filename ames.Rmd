---
title: "Welcome to [Ames](https://www.cityofames.org/), Iowa USA!"
author: "Jarad Niemi"
date: "`r Sys.Date()`"
output: 
...
(we've heard the first ride is FREE for new ISU students)
...
while being [26th in size and 30th in population](https://www.ipl.org/div/stateknow/popchart.html)
...
- Geographically
  - Anywhere in Ames
    - North of Bloomington Rd is Gilbert School District
...
## University Housing Details

- Strict [Move-in](https://www.housing.iastate.edu/guide/move-in/fall/)/Move-out Dates
    - [Interim Housing ($25/night)](https://www.housing.iastate.edu/guide/move-in/fall/early-arrivals/)
    - [ISSO Temporary Housing ($99/night)](https://isso.dso.iastate.edu/new-student-orientation/fall-orientation/graduate-and-transfer-students)
- Expense is per semester and billed up front
...
- Rental agreements run Aug 1 to July 31
...
- Required
  - [Natural gas](https://www.alliantenergy.com/)
  - [Electricity/Water/Sewer](https://www.cityofames.org/government/departments-divisions-i-z/utilities-and-parking-tickets/municipal-utilities-online-customer-service)
  - [Garbage/Recycling/Compost](https://www.cityofames.org/government/departments-divisions-i-z/resource-recovery-system/licensed-area-haulers)
- Optional
  - Cell phones
  - Internet
...
## [City of Ames Electric](https://www.cityofames.org/government/departments-divisions-a-h/electric/electric-utility-service)
...
## [Cell phones](https://coveragecritic.com/coverage-model/best-cell-phone-coverage-plans-in-ames-ia/)

![](figs/cellphone_coverage.png){width=90%}
...
- [Fareway](https://www.fareway.com/), [Aldi](https://www.aldi.us/)
- [Target](https://www.target.com/), [Wal-Mart](https://www.walmart.com/)
...
## Thunderstorms/tornados/derecho
...
## [Story County Severe Weather Alert](https://www.storycountyiowa.gov/1155/Story-County-Iowa-Alerts)

- [Opt-In to Receive Severe Weather Alerts on your phone](https://www.storycountyiowa.gov/1155/Story-County-Iowa-Alerts)
- [siren test first Wednesday of every month at 10am](https://www.cityofames.org/Home/Components/Calendar/Event/8898/31)
- [Tornado Watch < Tornado Warning](https://www.weather.gov/safety/tornado-ww)
...
- [Torrent Brewing Company](http://torrentbrewingco.com/), [Alluvial Brewing](https://www.alluvialbrewing.com/)
- [Prairie Moon Winery](https://prairiemoonwinery.com/)



## [Ames Parks and Recreation](https://www.cityofames.org/government/departments-divisions-i-z/parks-recreation)


![](figs/ames_park_and_rec_program.jpg){width=40%}
...
provide updates by generating a pull request at 

https://github.com/isustatistics/grad_orientation
